      ...
      if (data.socket == socketid) {
        ...
        for (var i = 0; i < hand.length; i++) {
          ...
          if (hand[i].card == "remington") {
            ...
            $('#mainHand').append(`<img data-target="${hand[i].card}Modal" href="#${hand[i].card}Modal"src="assets/cards/${hand[i].card}.png" alt="general" class="responsive ${hand[i].card}" data-handpos="${i} hoverCard" data-handpos="${i}">`)
            generalstore = "true"
          }
          else {
